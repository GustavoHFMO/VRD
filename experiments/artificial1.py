...
EXP = Experiment(pasta='ICDM(GaussianVirtual)/Artificial/Time Execution')
    
# 2. INSTANTIATE THE MODELS TO BE RUNNED
MODELS = [LDD_DSDA(train_size=50), POGMM_VRD(batch_size=50)]

#4. RUNNING THE MODELS CHOSEN
EXP.run(cross_validation=True, models=MODELS, datasets=[0, 7], executions=[0, 2])
